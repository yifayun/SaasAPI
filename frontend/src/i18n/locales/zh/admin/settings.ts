export default {
    settings: {
      ...
      site: {
        ...
        footerLegalTitle: '页脚备案信息',
        footerLegalDescription: '填写后将展示在首页及公开页面底部，用于悬挂 ICP 备案号、公安备案号等合规信息。',
        footerIcpNumber: 'ICP 备案号',
        footerIcpNumberPlaceholder: '例如：京ICP备12345678号-1',
        footerIcpNumberHint: '工信部 ICP 备案号，留空则不显示。',
        footerIcpUrl: 'ICP 备案链接',
        footerIcpUrlPlaceholder: 'https://beian.miit.gov.cn/',
        footerIcpUrlHint: '点击备案号跳转的链接，留空则默认指向工信部备案查询网站。',
        footerPsbNumber: '公安备案号',
        footerPsbNumberPlaceholder: '例如：京公网安备11010802012345号',
        footerPsbNumberHint: '公安机关备案号，留空则不显示。',
        footerPsbUrl: '公安备案链接',
        footerPsbUrlPlaceholder: 'http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=...',
        footerPsbUrlHint: '点击公安备案号跳转的链接。',
