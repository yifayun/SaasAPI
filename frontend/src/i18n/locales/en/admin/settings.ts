export default {
    settings: {
      ...
      site: {
        ...
        footerLegalTitle: 'Footer Legal Filings',
        footerLegalDescription: 'When filled in, these appear at the bottom of the homepage and other public pages (ICP filing, public security filing, etc.).',
        footerIcpNumber: 'ICP Filing Number',
        footerIcpNumberPlaceholder: 'e.g. 京ICP备12345678号-1',
        footerIcpNumberHint: 'MIIT ICP filing number. Leave empty to hide.',
        footerIcpUrl: 'ICP Filing URL',
        footerIcpUrlPlaceholder: 'https://beian.miit.gov.cn/',
        footerIcpUrlHint: 'Link when clicking the ICP number. Defaults to the MIIT filing site if empty.',
        footerPsbNumber: 'Public Security Filing Number',
        footerPsbNumberPlaceholder: 'e.g. 京公网安备11010802012345号',
        footerPsbNumberHint: 'Public security bureau filing number. Leave empty to hide.',
        footerPsbUrl: 'Public Security Filing URL',
        footerPsbUrlPlaceholder: 'http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=...',
        footerPsbUrlHint: 'Link when clicking the public security filing number.',
